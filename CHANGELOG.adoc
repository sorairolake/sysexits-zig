...
* Migrate to Zig version 0.16.0 ({pull-request-url}/63[#63])

== {compare-url}/v0.2.9\...v0.2.10[0.2.10] - 2025-08-22

=== Changed

* Change the license for documents to CC BY 4.0 ({pull-request-url}/21[#21])
* Migrate to Zig version 0.15.1 ({pull-request-url}/26[#26])
